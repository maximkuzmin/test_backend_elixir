defmodule GeospatialApiWeb.JobsInRadiusController do
  ...
  defp validate_params(params) do
    ...
    changeset =
      ...
      |> Changeset.validate_number(:lattitude, less_than_or_equal_to: 90.0, greater_than_or_equal_to: -90.0)
      |> Changeset.validate_number(:longitude, less_than_or_equal_to: 90.0, greater_than_or_equal_to: -90.0)
